...
export const getAllEventCategory = ({ pageNo = 1, pageSize = 10, options = {} } = {}) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({
      ...
      payload: { data: response.data.data, total: response.data.total, pageNo, pageSize },
    });
  } catch (error) {
...
export const createEventCategory = (categoryData) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.post(`${API_URL}/event-category/create`, categoryData, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const updateEventCategory = (categoryId, categoryData) => async (dispatch) => {
  dispatch({ type: EDIT_EVENT_CATEGORY_REQUEST });
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.put(`${API_URL}/event-category/update/${categoryId}`, categoryData, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const deleteEventCategory = (categoryId) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.delete(`${API_URL}/event-category/delete/${categoryId}`, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const getAllEventLocation = ({ pageNo = 1, pageSize = 10, options = {} } = {}) => async (dispatch) => {
...
export const createEventLocation = (locationData) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.post(`${API_URL}/event-location/create`, locationData, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const updateEventLocation = (locationId, locationData) => async (dispatch) => {
  dispatch({ type: EDIT_EVENT_LOCATION_REQUEST });
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.put(`${API_URL}/event-location/update/${locationId}`, locationData, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const deleteEventLocation = (locationId) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.delete(`${API_URL}/event-location/delete/${locationId}`, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const getAllEventAdvertisement = ({ pageNo = 1, pageSize = 10, options = {} } = {}) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({ type: FETCH_EVENT_ADVERTISEMENT_FAILURE, payload: error.message });
  }
};

export const createEventAdvertisement = (advertisementData) => async (dispatch) => {
  dispatch({ type: CREATE_EVENT_ADVERTISEMENT_REQUEST });
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.post(`${API_URL}/event-advertisement/create`, advertisementData, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: CREATE_EVENT_ADVERTISEMENT_SUCCESS, payload: response.data.data });
    return response.data;
  } catch (error) {
    dispatch({ type: CREATE_EVENT_ADVERTISEMENT_FAILURE, payload: error.message });
    throw error;
  }
};

export const updateEventAdvertisement = (advertisementId, advertisementData) => async (dispatch) => {
  dispatch({ type: EDIT_EVENT_ADVERTISEMENT_REQUEST });
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.put(`${API_URL}/event-advertisement/update/${advertisementId}`, advertisementData, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: EDIT_EVENT_ADVERTISEMENT_SUCCESS, payload: response.data.data });
    return response.data;
  } catch (error) {
    dispatch({ type: EDIT_EVENT_ADVERTISEMENT_FAILURE, payload: error.message });
    throw error;
  }
};

export const deleteEventAdvertisement = (advertisementId) => async (dispatch) => {
  dispatch({ type: DELETE_EVENT_ADVERTISEMENT_REQUEST });
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.delete(`${API_URL}/event-advertisement/delete/${advertisementId}`, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: DELETE_EVENT_ADVERTISEMENT_SUCCESS, payload: advertisementId });
    return response.data;
  } catch (error) {
...
export const getAllEventCreation = ({ pageNo = 1, pageSize = 10, options = {} } = {}) => async (dispatch) => {
...
export const createEventCreation = (eventData) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.post(`${API_URL}/event-creation/create`, eventData, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: CREATE_EVENT_CREATION_SUCCESS, payload: response.data.data });
    return response.data;
  } catch (error) {
...
export const updateEventCreation = (eventId, eventData) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.put(`${API_URL}/event-creation/update/${eventId}`, eventData, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: EDIT_EVENT_CREATION_SUCCESS, payload: response.data.data });
    return response.data;
  } catch (error) {
...
export const deleteEventCreation = (eventId) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.delete(`${API_URL}/event-creation/delete/${eventId}`, {
      headers: { Authorization: `Bearer ${token}` }
    });
...
export const publishEventCreation = (eventId) => async (dispatch) => {
  ...
  try {
    const token = await getValidToken(dispatch);
    const response = await axiosInstance.put(`${API_URL}/event-creation/publish/${eventId}`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    });

    dispatch({ type: PUBLISH_EVENT_CREATION_SUCCESS, payload: response.data.data });
    return response.data;
  } catch (error) {
