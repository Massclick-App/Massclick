...
import HeroSection from "features/public/hero-section/heroSection.js";
import CategoryBar from "features/public/categoryBar.js";
...
} from "shared/utils/seoSchemaGenerators.js";
...
import styles from "features/public/HomePage.module.css";
...
const ServiceCardsGrid = lazy(
  () => import("features/public/service-card/serviceCard.js"),
);
const LeadAwareness = lazy(
  () => import("features/public/lead-awareness/LeadAwareness.js"),
);
const PublicUserCounter = lazy(
  () => import("features/public/public-user-counter/PublicUserCounter.js"),
);
const TwoWayAwareness = lazy(
  () => import("features/public/two-way-awareness/TwoWayAwareness.js"),
);
const MassclickEvents = lazy(
  () => import("features/public/massclick-events/MassclickEvents.js"),
);
const EventCarousel = lazy(
  () => import("features/public/events/eventCarousel/eventCarousel.js"),
);
const TrendingSearchesCarousel = lazy(
  () => import("features/public/trending-search/trendingSearch.js"),
);
const CardCarousel = lazy(() => import("features/public/popular-search/popularSearch.js"));
const TopTourist = lazy(() => import("features/public/top-tourist/topTourist.js"));
const PopularCategoriesLink = lazy(
  () => import("features/public/popular-categories/popularCategories.js"),
);
const Footer = lazy(() => import("features/public/footer/Footer.js"));
const PageHeaderContents = lazy(
  () => import("features/public/page-header-content/pageHeaderContents.js"),
);
const RelatedBlogs = lazy(() => import("features/public/related-blogs/relatedBlogs.js"));
const WeatherWidget = lazy(() => import("features/public/weather-widget/weatherWidget.js"));
const StickySearchBar = lazy(() =>
  import(
    /* webpackChunkName: "sticky-search" */ "features/public/sticky-search-bar/StickySearchBar.js"
  )
);
const MobileTrustBanner = lazy(() =>
  import(
    /* webpackChunkName: "mobile-trust-banner" */ "features/public/mobile-home-dock/MobileTrustBanner.js"
  )
);
const OTPLoginModel = lazy(() =>
  import(/* webpackChunkName: "otp-modal" */ "features/public/auth/AddBusinessModal.js")
);
