...
import { createStartProject } from 'state/actions/startProjectAction.js';
import { Container, Grid, Card, CardContent, Typography, Button, Box, Modal, CircularProgress } from '@mui/material';
import SeoMeta from "features/public/seo/seoMeta.js";
import { fetchSeoMeta } from "state/actions/seoAction.js";
import { generateServiceSchema, generateBreadcrumbSchema } from "shared/utils/seoSchemaGenerators.js";
...
import styles from "features/public/footer/web-dev/webDevSection.module.css";
...
const featuresData = [{
  ...
  description: "We believe in the power of customization. We take the time to understand your business, target audience, and goals to create a website that reflects your unique brand identity.",
  icon: AutoFixHighIcon
}, {
  title: "User-Centric Design",
  description: "By placing your users at the center of our design process, we ensure that every interaction on your website is seamless and enjoyable, leading to increased engagement and conversions.",
  icon: MapIcon
}, {
  title: "Responsive & Mobile-First",
  description: "Our team excels in crafting websites that adapt seamlessly to different screen sizes, ensuring your site looks and functions flawlessly on all devices.",
  icon: DevicesIcon
}, {
  title: "Cutting-Edge Technologies",
  description: "We stay at the forefront, leveraging the latest technologies and frameworks (HTML5, CSS3, JavaScript, CMS, E-commerce) to deliver outstanding results.",
  icon: RocketLaunchIcon
}, {
  title: "SEO-Friendly Architecture",
  description: "A beautiful website must be discoverable. We design sites with SEO best practices and clean architecture built-in for better search engine results.",
  icon: TrendingUpIcon
}, {
  title: "Ongoing Support",
  description: "Our commitment continues post-launch. We provide comprehensive support and maintenance to ensure your website remains secure, up-to-date, and performs optimally.",
      ...
      padding: {
        ...
        boxShadow: '0 -5px 15px rgba(0, 0, 0, 0.05)'
          ...
          placeholder="Phone Number (Optional)" name="phone" value={formData.phone} onChange={handleChange} type="tel" />
                        ...
                        <textarea required className={cx("custom-form-textarea")} // Custom class for styling
          placeholder="Tell Us About Your Project *" name="message" value={formData.message} onChange={handleChange} rows={4} />
