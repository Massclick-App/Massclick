...
import styles from "features/public/sticky-search-bar/StickySearchBar.module.css";
...
import { selectSearchLogs } from "state/selectors/index.js";
...
import { getCorrectionSuggestionOption, getSearchSuggestionValue } from "shared/utils/searchSuggestionIntent.js";
...
const CategoryDropdown = lazy(() =>
  import(
    /* webpackChunkName: "category-dropdown" */ "features/public/category-dropdown/CategoryDropdown.js"
  )
);
