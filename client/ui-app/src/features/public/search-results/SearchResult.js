...
import CardDesign from "features/public/cards/cards.js";
import { formatBusinessAddress } from "shared/utils/formatBusinessAddress.js";
...
} from "state/actions/businessListAction.js";
import { buildBusinessPath, buildCategoryPath, extractSearchResultData } from "shared/utils/searchResultNavigation.js";
...
import TopBannerAds from "features/public/banners/top-banner/TopBanner.js";
import CategoryPublicCounterBadge from "features/public/public-user-counter/CategoryPublicCounterBadge.js";
...
import { trackSearch } from "shared/utils/webTracker.js";
import { buildCrumbs, crumbsToJsonLd, crumbsToUiItems } from "shared/utils/breadcrumbs.js";
import { submitSearchIntent } from "shared/utils/searchIntent.js";
...
const FilterPanel = lazy(() =>
  import(/* webpackChunkName: "filter-panel" */ "features/public/search-results/FilterPanel.js")
);
const MobileFilterDrawer = lazy(() =>
  import(
    /* webpackChunkName: "mobile-filter-drawer" */ "features/public/search-results/MobileFilterDrawer.js"
  )
);
...
const NoResultsRequestForm = lazy(() =>
  import(/* webpackChunkName: "no-results-request" */ "features/public/search-results/NoResultsRequestForm.js")
);
