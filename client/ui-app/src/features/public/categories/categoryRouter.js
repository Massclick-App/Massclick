...
const CategoriesPage = lazy(() =>
  import(/* webpackChunkName: "category-directory" */ "features/public/categories/categories.js")
);
let searchResultsModulePromise;
const loadSearchResults = () => {
  if (!searchResultsModulePromise) {
    searchResultsModulePromise = import(
      /* webpackChunkName: "search" */ "features/public/search-results/SearchResult.js"
    );
  }
  ...
  return (
    <Suspense fallback={null}>
      <SearchResults
        ...
        initialSearchTelemetry={prefetchedResults?.searchTelemetry}
      />
    </Suspense>
  );
};
