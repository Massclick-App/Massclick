...
const PetShopsCards = () => {
  ...
  return (
    <>
      ...
      {loading && (
        <p className="loading-text">Loading pet shops...</p>
      )}

      {!loading && petShopList.length === 0 && (
        <div className="no-results-container">
          <p className="no-results-title">No Pet Shops Found 😔</p>
          <p className="no-results-suggestion">
            We don’t have pet shops listed right now.
          </p>
          <button
            className="go-home-button"
