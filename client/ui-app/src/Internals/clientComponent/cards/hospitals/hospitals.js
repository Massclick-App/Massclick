...
const HospitalsCards = () => {
  ...
  const hospitalList = categoryBusinessList[CATEGORY] || [];
  ...
  return (
    <>
      ...
      {!loading && hospitalList.length === 0 && (
        <div className="no-results-container">
          <p className="no-results-title">No Hospitals Found 😔</p>
          <p className="no-results-suggestion">
            We don’t have hospitals listed right now.
          </p>
          <button
            className="go-home-button"
