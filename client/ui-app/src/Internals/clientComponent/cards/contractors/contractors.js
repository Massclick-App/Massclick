...
const ContractorsCards = () => {
  ...
  const contractorList = categoryBusinessList[CATEGORY] || [];
  ...
  return (
    <>
      ...
      {!loading && contractorList.length === 0 && (
        <div className="no-results-container">
          <p className="no-results-title">No Contractors Found 😔</p>
          <p className="no-results-suggestion">
            We don’t have contractors listed right now.
          </p>
          <button
            className="go-home-button"
