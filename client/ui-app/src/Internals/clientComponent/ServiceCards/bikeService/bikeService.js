...
const BikeServiceCards = () => {
  ...
  const bikeServiceList = categoryBusinessList[CATEGORY] || [];
  ...
  return (
    <>
      ...
      {loading && (
        <p className="loading-text">Loading Bike Services...</p>
      )}
