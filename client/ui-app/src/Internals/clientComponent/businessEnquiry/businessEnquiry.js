...
const BusinessEnquiry = () => {
    ...
    const validationRules = {
        ...
        contactNumber: {
            required: true,
            pattern: /^\+?[1-9]\d{1,14}$/, // International E.164 format
            message: "Contact number must be a valid international format (e.g., +1234567890 or 1234567890)"
        },
        businessPhone: {
            pattern: /^[\d\s+()-]*$/, // Optional, but if provided must be valid format
    ...
    const renderFieldWithError = (fieldName, label, icon, type = "text", placeholder = "") => {
        ...
        return (
            <div className="enquiry-form-group" key={fieldName}>
                <label>
                    {icon}
                    {label}
                    {validationRules[fieldName]?.required && <span className="required-asterisk">*</span>}
                </label>
                <div className="form-field-wrapper">
                    ...
                    />
                    {hasError && (
                        <div className="error-message" id={`${fieldName}-error`}>
                            <AlertCircle size={16} />
                            {error}
                        </div>
                    )}
        ...
        <>
            ...
            <div className="enquiry-wrapper">
                ...
                <div className="enquiry-container">
                    ...
                    <div className="enquiry-grid">
                        ...
                        <div className="enquiry-form-group">
                            ...
                            <div className="form-field-wrapper">
                                <input
                                    ...
                                    className={`form-input ${formErrors.businessPhone ? "input-error" : ""}`}
                                />
                        ...
                        <div className="enquiry-form-group full">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                placeholder="Additional details about your business inquiry..."
                    ...
                    <button 
                        className={`enquiry-submit-btn ${!isFormValid ? "btn-disabled" : ""}`}
