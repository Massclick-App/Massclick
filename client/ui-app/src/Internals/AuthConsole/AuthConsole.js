...
import CustomerSessionsPanel from "../user/CustomerSessionsPanel.js";
import {
  AUTH_STATE_EVENT,
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <CustomerSessionsPanel
        description="Customer tokens are stateless, so logging out bumps their token version. They can sign in again with OTP straight away."
      />
