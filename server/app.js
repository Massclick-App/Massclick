...
import msg91AnalyticsRoutes from "./routes/msg91AnalyticsRoutes.js";
import phonePayRoutes from "./routes/phonePayRoute.js";
import rechargeOrderRoutes from "./routes/rechargeOrderRoutes.js";
import rechargeBbpsRoutes from "./routes/rechargeBbpsRoutes.js";
...
import publicizeRoute from "./routes/publicizeRoute.js";
...
import businessSuggestionRoutes from "./routes/businessSuggestionRoutes.js";
import webAnalyticsRoutes from "./routes/webAnalyticsRoute.js";
import businessPersonReportRoutes from "./routes/businessPersonReportRoutes.js";
...
app.use("/", otpRoutes);
app.use("/", msg91AnalyticsRoutes);
app.use("/", phonePayRoutes);
app.use("/", rechargeOrderRoutes);
app.use("/", rechargeBbpsRoutes);
...
app.use("/", businessSuggestionRoutes);
app.use("/", webAnalyticsRoutes);
app.use("/", businessPersonReportRoutes);
