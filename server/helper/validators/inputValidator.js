...
class InputValidator {
  ...
  // NOTE: Location validity is checked against the locations collection in MongoDB,
  // not hardcoded here. The validator only checks format (letters/spaces/commas).
  // Actual existence is validated by the business controller against the DB.
